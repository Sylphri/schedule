...
namespace schedule
{
    ...
    public partial class EditClassroomsWindow : Window
    {
        ...
        private void changeButton_Clicked(object sender, RoutedEventArgs e)
        {
            ...
            int classroomIndex = Grid.GetRow(changeButton);
            ...
            _classrooms[classroomIndex].title = classroomName;
            changeButton.IsEnabled = false;

            scheduleDBConnection.UpdateClassroom(_classrooms[classroomIndex]);
            UpdateFieldsGrid();
        }
        ...
        private void deleteButton_Clicked(object sender, RoutedEventArgs e)
        {
            ...
            MessageBoxResult deleteMessageBoxResult = MessageBox.Show($"Ви впевнені, що хочете видалити аудиторію '{classroomName}' і всі пов'язані з нею записи у розкладі?", 
